...
exports.PieceTreeBase = exports.StringBuffer = exports.Piece = exports.LineStarts = exports.AverageBufferSize = void 0;
...
var rbTreeBase_1 = require("./rbTreeBase");
...
var PieceTreeBase = /** @class */ (function () {
    ...
    PieceTreeBase.prototype.getLineRawContent = function (lineNumber, endOffset) {
        ...
        if (cache) {
            ...
            while (x !== rbTreeBase_1.SENTINEL) {
                if (x.left !== rbTreeBase_1.SENTINEL && x.lf_left >= lineNumber - 1) { // go left 
                    x = x.left;
                }
                else if (x.lf_left + x.piece.lineFeedCnt > lineNumber - 1) { // line is inside
                ...
                else if (x.lf_left + x.piece.lineFeedCnt === lineNumber - 1) { // last line 
                    var prevAccumualtedValue = this.getAccumulatedValue(x, lineNumber - x.lf_left - 2);
                    var buffer = this._buffers[x.piece.bufferIndex].buffer;
                    var startOffset = this.offsetInBuffer(x.piece.bufferIndex, x.piece.start);
                    ret = buffer.substring(startOffset + prevAccumualtedValue, startOffset + x.piece.length);
    ...
    PieceTreeBase.prototype.rbInsertRight = function (node, p) {
        var z = new rbTreeBase_1.TreeNode(p, 1 /* NodeColor.Red */);
        ...
        if (x === rbTreeBase_1.SENTINEL) {
            ...
            var nextNode = (0, rbTreeBase_1.leftest)(node.right);
            nextNode.left = z;
            z.parent = nextNode;
        }
    ...
    PieceTreeBase.prototype.rbInsertLeft = function (node, p) {
        ...
        if (this.root === rbTreeBase_1.SENTINEL) {
            ...
            var prevNode = (0, rbTreeBase_1.righttest)(node.left); // a
            prevNode.right = z;
            z.parent = prevNode;
        }
        (0, rbTreeBase_1.fixInsert)(this, z);
